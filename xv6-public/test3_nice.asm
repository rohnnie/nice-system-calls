...
_test3_nice:     file format elf32-i386
...
int main() {
  ...
  18:	e8 a3 03 00 00       	call   3c0 <printf>
    nice(70,3);
  1d:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
  24:	00 
  25:	c7 04 24 46 00 00 00 	movl   $0x46,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 6f 07 00 00 	movzbl 0x76f(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ef:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4f1:	b8 68 07 00 00       	mov    $0x768,%eax
...
free(void *ap)
{
 ...
 61f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 622:	a3 e4 09 00 00       	mov    %eax,0x9e4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 1d e4 09 00 00    	mov    0x9e4,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 689:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 68b:	3b 15 e4 09 00 00    	cmp    0x9e4,%edx
...
morecore(uint nu)
{
 ...
 6bd:	e8 ee fe ff ff       	call   5b0 <free>
  return freep;
 6c2:	8b 15 e4 09 00 00    	mov    0x9e4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 e4 09 00 00 e8 	movl   $0x9e8,0x9e4
 705:	09 00 00 
    base.s.size = 0;
 708:	ba e8 09 00 00       	mov    $0x9e8,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70d:	c7 05 e8 09 00 00 e8 	movl   $0x9e8,0x9e8
 714:	09 00 00 
    base.s.size = 0;
 717:	c7 05 ec 09 00 00 00 	movl   $0x0,0x9ec
 71e:	00 00 00 
